...
public interface AppointmentVerificationRepository extends JpaRepository<AppointmentVerification, UUID> {
    ...
    Optional<AppointmentVerification> findByAppointmentIdAndCode(UUID appointmentId, String code);

    Optional<AppointmentVerification> findTopByAppointmentIdOrderByCreatedAtDesc(UUID appointmentId);
}
