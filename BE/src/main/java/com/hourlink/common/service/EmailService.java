    ...
    public void sendWarningEmail(String toEmail, String fullName, int warningCount, String reason) {
        ...
        try {
            ...
            String htmlContent = String.format(
                ...
                "      <a href=\"#\" style=\"display: inline-block; background-color: #10b981; color: white; padding: 12px 24px; font-size: 14px; font-weight: bold; text-decoration: none; border-radius: 8px; box-shadow: 0 2px 4px rgba(16, 185, 129, 0.2);\">Tru cập website HourLink</a>" +
                "    </div>" +
                "  </div>" +
                "  <!-- Footer -->" +
    ...
    public void sendResetPasswordEmail(String toEmail, String fullName, String newPassword) {
        ...
        try {
            ...
            String htmlContent = String.format(
                ...
                "    </p>" +
                "    <div style=\"margin-top: 30px; text-align: center;\">" +
                "      <a href=\"#\" style=\"display: inline-block; background-color: #10b981; color: white; padding: 12px 24px; font-size: 14px; font-weight: bold; text-decoration: none; border-radius: 8px; box-shadow: 0 2px 4px rgba(16, 185, 129, 0.2);\">Đăng nhập ngay</a>" +
                "    </div>" +
                "  </div>" +
                "  <!-- Footer -->" +
                "  <div style=\"background-color: #f8fafc; padding: 20px; text-align: center; border-top: 1px solid #f1f5f9;\">" +
