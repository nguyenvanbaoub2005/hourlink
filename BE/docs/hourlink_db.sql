...
CREATE TABLE `chat_message` (
  ...
  `type` enum('TEXT','IMAGE','DOCUMENT','LOCATION','MEETING_LINK','RESCHEDULE_PROPOSAL','SYSTEM') COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `conversation` (
  ...
  `last_message_type` enum('TEXT','IMAGE','DOCUMENT','LOCATION','MEETING_LINK','RESCHEDULE_PROPOSAL','SYSTEM') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `notification` (
  ...
  `type` enum('INVITATION_RECEIVED','INVITATION_ACCEPTED','INVITATION_REJECTED','INVITATION_RESCHEDULED','INVITATION_CANCELLED','APPOINTMENT_REMINDER','NEW_RATING','NEW_MESSAGE','CHAT_RESCHEDULE_PROPOSED') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
